...
javaaddpath('/home/yuting/Projects/vstlf/lib/lapack.jar');
javaaddpath('/home/yuting/Projects/vstlf/lib/lapack_simple.jar');
...
symData = [[1.232, 0.111, 0.222];
           [0.111, 3.232, 0.783];
           [0.222, 0.783, 9.877]];
data1 = [[0.88934, 0.322232];
        [4.5334, 9.7372];
        [0.0032, 0.7764]];

symMulTest(symData, data1);
